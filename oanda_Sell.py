##https://github.com/hootnot/oanda-api-v20/blob/master/tests/test_orders.py

#https://oanda-api-v20.readthedocs.io/en/latest/examples.html
import json
...
mktOrder = LimitOrderRequest(
    instrument="EUR_USD",
    units=100,price=1.09880)  #price for select manual
